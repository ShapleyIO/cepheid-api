...
func NewCreateFeatureFlagRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/feature_flag")
	if operationPath[0] == '/' {
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/feature_flag", wrapper.CreateFeatureFlag)
	})
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/feature_flag/{id}", wrapper.DeleteFeatureFlag)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/feature_flag/{id}", wrapper.GetFeatureFlag)
	})
	r.Group(func(r chi.Router) {
		r.Put(options.BaseURL+"/feature_flag/{id}", wrapper.UpdateFeatureFlag)
	})
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+xWT0/8NhD9KtG0xyjZ33IoyqkLCLTqAVSEeqhWaEgmiSGxXXu8VYry3Ss7WXazfwCp",
	...
	"YU3GDm/PklnyzW+qNEnUAjI4S2bJGcSgkevATDpS81hubKxsADkFcmkImSKcsARhZxNk8dYcs3b7IgZD",
	"fziyfKGKbkMDyVABtW5EHt5On60vs2kv//SjoRIy+CHd9l86Nl+6WyGQPAW7iMZDRf5QUa5kKSo34BwR",
	"CUMFZGwc9T5gtZJ2sMp8NvsvcI7tewTttXJy6r6h01zboune4Z69T7PfYWrclX95omr6Kop+kLQhpkNx",
	"r0Lc7lWILrpoWRxoPCRPNdZosCUm4/GMc8A7bDsFwlCaEh/vkPjB+OpXx0WaHuPe5TlZW7qm6aIBZrHP",
	"2pTZDw5+iuAYKjrSIzfEn+TwhvhrEPiFXP4ee6eF0O6IEA+6OGyYE1IMuf+HGt/H4j8zzPsqnxyO4SPG",
	"rDfiusn9ng83aTK5k08mcXU6MUvTRuXY1Mpydj47nx2uf5v/lIQrelxfvaHeN/TtxrI2QhN4aVFiJWS1",
	"99XyZtC9j5lV/3cAAAD//3BGtsHICgAA",
}
